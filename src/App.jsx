    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        @media(min-width:1024px){.app{max-width:none;margin:0;padding-bottom:0;flex:1}.main-content{display:flex;flex:1;justify-content:center}.primary-panel{flex:1;max-width:700px;min-width:500px;border-right:1px solid var(--border);overflow-y:auto;height:100vh}.secondary-panel{width:350px;background:var(--card);padding:24px;overflow-y:auto;height:100vh;flex-shrink:0;border-right:1px solid var(--border)}.bottom-nav{display:none!important}.fab{bottom:32px;right:32px}}
